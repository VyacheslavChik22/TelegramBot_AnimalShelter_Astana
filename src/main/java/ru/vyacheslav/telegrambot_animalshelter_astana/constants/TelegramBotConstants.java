...
public class TelegramBotConstants {
    ...
    public static final String LIST_MENU_CAT =
            "\n/info2   -  Узнать информацию о приюте\n" +
                    "/how2    - Как взять кошку из приюта\n" +
                    "/report - Прислать отчет о питомце\n" +
                    "/call      - Позвать волонтера\n" +
                    "/repeat - Повторное обращение\n" +
                    "/start";

    public static final String INFO_TEXT_DOG = " Приют для животных реализован в рамках государственно-частного партнерства," +
            "Находиться приют в районе спецЦОНа (автоЦОН).В новом питомнике для животных постоянно содержаться около четырехсот собак." +
    ...
    public static final String INFO_TEXT_CAT = " Приют для кошек реализован в рамках государственно-частного партнерства," +
            "Находиться приют в районе спецЦОНа (автоЦОН).В новом питомнике для животных постоянно содержаться около  ста кошек." +
            "В нем есть специально оборудованная территория для выгула и тренировок домашних животных, вет.лечебница. В питомнике можно посетить" +
            " контактный мини-зоопарк, дрессировочные площадки, карантинный отсек и блок стерилизации животных.\n/menu2";
